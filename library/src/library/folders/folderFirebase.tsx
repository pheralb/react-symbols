...
const FolderFirebaseOld: FC<ComponentProps<"svg">> = (props) => (
  ...
  >
    ...
    >
      <path
        fill="#fff"
        d="M22.962 13.452a.251.251 0 00-.424-.137l-1.294 1.304-1.025-1.94a.244.244 0 00-.438 0l-.556 1.06-1.406-2.607c-.113-.212-.431-.156-.469.08L16 19.86l3.619 2.027a.761.761 0 00.731 0L24 19.86l-1.038-6.407z"
      ></path>
    </mask>
    <g mask="url(#mask0_24689_554)">
      <path
        fill="url(#paint0_linear_24689_554)"
        d="M22.962 13.452a.251.251 0 00-.424-.137l-1.294 1.304-1.025-1.94a.244.244 0 00-.438 0l-.556 1.06-1.406-2.607c-.113-.212-.431-.156-.469.08L16 19.86l3.619 2.027a.761.761 0 00.731 0L24 19.86l-1.038-6.407z"
      ></path>
      <path
        fill="#FFA000"
        d="M16 19.859l1.356-8.646c.038-.237.356-.293.469-.081l1.4 2.607.556-1.06a.25.25 0 01.444 0L24 19.859h-8z"
      ></path>
      <path fill="url(#pattern0)" d="M15.5 13.184H20.938V20.108H15.5z"></path>
      <path
        fill="#F57C00"
        d="M20.675 16.49l-1.456-2.75L16 19.858l4.675-3.369z"
      ></path>
      <path fill="url(#pattern1)" d="M15.75 12.685H24.5V22.292H15.75z"></path>
      <path
        fill="#FFCA28"
        d="M24 19.859l-1.038-6.407a.251.251 0 00-.424-.137L16 19.86l3.619 2.027a.761.761 0 00.731 0L24 19.86z"
      ></path>
      <path
        fill="#fff"
        fillOpacity="0.2"
        d="M22.962 13.452a.251.251 0 00-.424-.137l-1.294 1.304-1.025-1.94a.244.244 0 00-.438 0l-.556 1.06-1.406-2.607c-.113-.212-.431-.156-.469.08L16 19.86h-.006l.006.006.038.019 5.2-5.203 1.3-1.297a.252.252 0 01.424.137l1.026 6.344.012-.006-1.038-6.407zm-6.95 6.394l1.344-8.57c.038-.238.356-.294.469-.082l1.4 2.608.556-1.06a.25.25 0 01.444 0l1 1.896-5.213 5.208z"
      ></path>
      <path
        fill="#A52714"
        d="M20.35 21.824a.761.761 0 01-.731 0l-3.613-2.021-.006.056 3.619 2.027a.761.761 0 00.731 0L24 19.86l-.006-.056-3.644 2.021z"
        opacity="0.2"
      ></path>
      <path
        fill="url(#paint1_linear_24689_554)"
        d="M22.962 13.452a.251.251 0 00-.424-.137l-1.294 1.304-1.025-1.94a.244.244 0 00-.438 0l-.556 1.06-1.406-2.607c-.113-.212-.431-.156-.469.08L16 19.86l3.619 2.027a.761.761 0 00.731 0L24 19.86l-1.038-6.407z"
      ></path>
    </g>
    <path
    ...
    <defs>
      ...
      >
        <use
          ...
          xlinkHref="#image1_24689_554"
        ></use>
      </pattern>
      <linearGradient
        id="paint0_linear_24689_554"
        x1="15.722"
        x2="25.683"
        y1="12.87"
        y2="18.148"
